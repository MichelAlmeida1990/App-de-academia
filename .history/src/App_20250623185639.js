...
// Limpeza automática para deploy limpo
import { autoCleanForProduction } from './utils/clearAllData';
 ...
 */
function App() {
  // Executa limpeza automática apenas em produção
  React.useEffect(() => {
    autoCleanForProduction();
  }, []);
