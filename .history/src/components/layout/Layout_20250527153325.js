// src/components/layout/Layout.js (Versão Aprimorada para Altura do Conteúdo)
...
          />
          
          {/* Container do conteúdo principal - Adicionado min-h-full para garantir que o conteúdo preencha a altura */}
          {/* Ajuste de min-height para compensar o header e o padding */}
          <div className="relative max-w-6xl mx-auto w-full min-h-[calc(100vh-theme(spacing.20)-theme(spacing.10))]">
            <PageTransition>
              <Outlet />
            </PageTransition>
          </div>
