...
import { FaMoon, FaSun, FaUser, FaDumbbell, FaChartLine, FaTachometerAlt, FaBars, FaTimes } from 'react-icons/fa';
          ...
          <AnimatePresence>
            {isMobileMenuOpen && (
              ...
              >
                ...
                {/* Painel do menu */}
                <motion.div
                  className={`absolute top-0 right-0 w-3/4 h-full max-w-xs ${
