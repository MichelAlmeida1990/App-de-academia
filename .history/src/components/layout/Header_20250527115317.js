// src/components/layout/Header.js - VERSÃO OTIMIZADA E CORRIGIDA
import React, { useState, useEffect, useRef } from 'react';
import { Link, NavLink, useNavigate, useLocation } from 'react-router-dom';
import { FaMoon, FaSun, FaUser, FaDumbbell, FaChartLine, FaTachometerAlt, FaBars, FaTimes, 
         FaCog, FaSignOutAlt, FaUserCircle, FaHome, FaQuestionCircle } from 'react-icons/fa';
...
const Header = () => {
  ...
  // Links de navegação corrigidos conforme App.js
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden">
            ...
            <motion.div
              ...
              } shadow-2xl flex flex-col z-[70] overflow-y-auto`}
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
            ...
            >
              {/* Cabeçalho do menu */}
              <div className={`p-6 border-b ${darkMode ? 'border-gray-800' : 'border-gray-200'} flex-shrink-0`}>
