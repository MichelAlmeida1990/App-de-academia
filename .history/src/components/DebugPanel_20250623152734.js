      ...
      <div className="min-h-screen p-4">
        <div className="bg-gray-900 text-white rounded-lg p-6 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
            ...
            <button
              onClick={() => runDebug(AuthDebugUtils.checkDuplicateWorkouts, 'Verificar Duplicatas')}
            ...
            <button
              onClick={() => runDebug(AuthDebugUtils.fixDataIsolation, 'Corrigir Problemas')}
            ...
            <button
              onClick={() => runDebug(AuthDebugUtils.clearAllWorkouts, 'Limpar Todos os Treinos')}
