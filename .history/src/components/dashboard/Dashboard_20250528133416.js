...
const Dashboard = () => {
  ...
  // Efeito para atualizar os treinos quando o componente for montado - APENAS UMA VEZ
  useEffect(() => {
    ...
    loadData();
    // Importante: incluir refreshWorkouts como dependência mas NÃO chamar novamente
