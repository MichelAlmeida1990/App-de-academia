  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <Card className="p-6">
          <div className="flex items-center mb-4">
            <FaClipboardList className="text-4xl text-purple-300 mr-4" />
        ...
        <Link to="/progress" className="block h-full">
          <Card className="p-6 flex flex-col items-center justify-center h-full hover:bg-white/10 transition-all duration-300">
        ...
        <Card className="p-6">
          ...
          {lastCompletedWorkout ? (
            <div>
              ...
              <Link to={`/workout/${lastCompletedWorkout.id}`} className="mt-4 inline-block text-purple-400 hover:text-purple-300 transition-colors duration-200">
                Ver detalhes
              </Link>
            </div>
          ) : (
            ...
            <ul>
              {upcomingWorkouts.map(workout => (
                <li key={workout.id} className="mb-2 pb-2 border-b border-gray-700 last:border-b-0">
                  <Link to={`/workout/${workout.id}`} className="text-lg font-medium text-white hover:text-purple-400 transition-colors duration-200">
                    {workout.name}
                  </Link>
