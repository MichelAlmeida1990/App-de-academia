// src/components/dashboard/Dashboard.js - REVISÃO DO LAYOUT
...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 items-stretch"> {/* Adicionado items-stretch aqui */}
        {/* Card 1: Total de Treinos */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 transition-transform transform hover:scale-105 duration-200 glassmorphism-card h-full flex flex-col justify-between"> {/* Adicionado h-full e flex helpers */}
...
        {/* Card 3: Veja seu Progresso - CORRIGIDO */}
        <Link to="/progress"
          className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 flex flex-col items-center justify-center h-full transition-transform transform hover:scale-105 duration-200 cursor-pointer glassmorphism-card"
        >
