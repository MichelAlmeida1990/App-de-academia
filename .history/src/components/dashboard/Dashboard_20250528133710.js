...
const Dashboard = () => {
  ...
  // Usando useCallback para memorizar a função loadData
  ...
  useEffect(() => {
    // Chamamos loadData apenas uma vez na montagem do componente
    loadData();
  }, [loadData]); // loadData é estável devido ao useCallback
