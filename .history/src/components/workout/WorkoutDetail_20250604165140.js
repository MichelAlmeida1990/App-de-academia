...
const WorkoutDetail = () => {
  ...
  // Função para garantir que exercises seja um array
  const getExercises = () => {
  ...
  const getWorkoutName = () => {
    return workout.name || workout.title || 'Treino sem nome';
  };
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex items-center mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-2xl font-bold text-gray-900">{getWorkoutName()}</h1>
          ...
          <div className="space-y-3">
            ...
            {workout.level && (
              <div>
                ...
                <span className="ml-2 inline-flex items-center px-3 py-1 bg-blue-100 text-blue-700 rounded-lg text-sm font-medium capitalize">
                  {workout.level}
                </span>
              </div>
            )}
                    ...
                    <div className="flex items-center flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600 mt-1">
                          ...
                          {exercise.rest && (
                            <span className="ml-2">• {exercise.rest}s descanso</span>
                          )}
                        </div>
                      </div>
                    </div>
