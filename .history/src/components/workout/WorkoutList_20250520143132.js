                  ...
                  return (
                    <div key={workout.id} className="p-4">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="relative" ref={showActionMenu === workout.id ? actionMenuRef : null}>
  <motion.button 
    whileHover={{ scale: 1.1 }}
    whileTap={{ scale: 0.9 }}
                        ...
                        <div className="mt-3 mb-4">
                          <div className="flex justify-between text-xs mb-1">
                            ...
                            <span className={`font-medium ${isCompleted ? 'text-green-500' : `text-${workoutColor}-500`}`}>
                              {isCompleted ? '100%' : `${workout.progress}%`}
                            </span>
                          </div>
                          <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <motion.div 
                              initial={{ width: 0 }}
                              animate={{ width: `${isCompleted ? 100 : workout.progress}%` }}
                      ...
                      <div className="flex justify-between items-center mt-4">
                        {isCompleted ? (
                          ...
                          <motion.button
                            ...
                            className={`inline-flex items-center px-4 py-2 bg-${workoutColor}-500 hover:bg-${workoutColor}-600 text-white rounded-lg text-sm font-medium shadow-sm`}
                          >
