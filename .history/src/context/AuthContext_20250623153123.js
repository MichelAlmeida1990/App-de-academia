...
export const AuthProvider = ({ children }) => {
  ...
  const loginWithGoogle = async () => {
    ...
    try {
      ...
      // ❌ CRIAÇÃO AUTOMÁTICA DE TREINOS DEMO DESABILITADA
      // Usuários devem criar seus próprios treinos
      console.log('ℹ️ Novo usuário Google - sem criação automática de treinos demo');
      console.log('ℹ️ Usuário pode criar treinos através da interface da aplicação');
  ...
  const signup = async (email, password, name) => {
    ...
    try {
      ...
      if (userCredential.user) {
        ...
        // ❌ CRIAÇÃO AUTOMÁTICA DE TREINOS DEMO DESABILITADA
        // Usuários devem criar seus próprios treinos
        console.log('ℹ️ Novo usuário cadastrado - sem criação automática de treinos demo');
        console.log('ℹ️ Usuário pode criar treinos através da interface da aplicação');
      }
