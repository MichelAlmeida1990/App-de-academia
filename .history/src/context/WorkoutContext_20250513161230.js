...
export const WorkoutProvider = ({ children }) => {
  ...
  const resetProgress = () => {
    ...
    console.log("Todo o progresso foi resetado com sucesso");
  };

  // Resetar o progresso de um treino específico
  const resetWorkoutProgress = (workoutId) => {
    // Remover o progresso deste treino específico
    setProgress(prev => {
    ...
    // Remover os exercícios concluídos deste treino
    setCompletedExercises(prev => {
      const newCompletedExercises = { ...prev };
      const workout = workouts.find(w => w.id === workoutId);
    ...
    // Remover o status de conclusão deste treino
    setCompletedWorkouts(prev => {
    ...
    console.log(`Progresso do treino ${workoutId} foi resetado com sucesso`);
  };
  ...
  const value = {
    ...
    resetProgress,           // Nova função para resetar todo o progresso
    resetWorkoutProgress     // Nova função para resetar o progresso de um treino específico
  };
