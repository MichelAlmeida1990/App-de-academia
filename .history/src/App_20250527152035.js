...
import { AuthProvider, useAuth } from './context/Auth/AuthContext'; // Ajuste o caminho se AuthContext estiver em Auth/AuthContext.js
...
          {/* Componentes globais */}
          <ConnectionStatus />
        </div> {/* Esta div estava fechando no lugar errado */}
      </Router>
    </MuiThemeProvider>
  );
};
