            ...
            <div className="hero-container">
              ...
              <div className="brand-section" style={{ animation: 'fadeInUp 1s ease-out' }}>
                <div className="flex flex-col">
                  ...
                  <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-6 animate-glow leading-tight">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-6 pt-6 border-t border-white/20">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white/80 font-medium text-sm lg:text-base">Analytics Avançado</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-2xl">🎯</span>
                        <span className="text-white/80 font-medium text-sm lg:text-base">IA Personalizada</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-2xl">🔥</span>
                        <span className="text-white/80 font-medium text-sm lg:text-base">Gamificação</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-2xl">💪</span>
                        <span className="text-white/80 font-medium text-sm lg:text-base">Comunidade Ativa</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-6 mt-6 pt-4">
                      <div className="text-center">
                        ...
                        <div className="text-xs lg:text-sm text-white/70">Atletas</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl lg:text-3xl font-bold text-white">500+</div>
                        <div className="text-xs lg:text-sm text-white/70">Exercícios</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl lg:text-3xl font-bold text-white">24/7</div>
                        <div className="text-xs lg:text-sm text-white/70">Suporte</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="form-section" style={{ animation: 'fadeInUp 0.8s ease-out 0.2s both' }}>
                <div className="premium-form" style={{ maxWidth: '450px', width: '100%' }}>
