  ...
  return (
    <>
      <style>{`
        ...
        /* Estes estilos são específicos para a HomePage e não devem afetar outras páginas */
        ...
        .homepage-container .glass-container {
        ...
        .homepage-container .glass-container::before {
          content: '';
          position: absolute;
          top: 0;
          left: 0;
        ...
        .homepage-container .premium-form {
        ...
        .homepage-container .premium-form::before {
          content: '';
          position: absolute;
          top: 0;
          left: 0;
        ...
        .homepage-container .feature-card::before {
          content: '';
          position: absolute;
          top: 0;
          left: -100%;
        ...
        .homepage-container .feature-card:hover::before {
          left: 100%;
        }

        .homepage-container .feature-card:hover {
          transform: translateY(-5px) scale(1.02);
          box-shadow: 0 15px 30px rgba(0, 0, 0, 0.15);
          border-color: rgba(255, 255, 255, 0.25);
        }

        .homepage-container .feature-icon {
          width: 50px;
          height: 50px;
          border-radius: 50%;
          display: flex;
        ...
        .homepage-container .feature-icon.gradient-purple {
          background: linear-gradient(135deg, #8b5cf6, #ec4899);
          box-shadow: 0 6px 20px rgba(139, 92, 246, 0.3);
        }

        .homepage-container .feature-icon.gradient-blue {
          background: linear-gradient(135deg, #3b82f6, #06b6d4);
          box-shadow: 0 6px 20px rgba(59, 130, 246, 0.3);
        }

        .homepage-container .feature-icon.gradient-green {
          background: linear-gradient(135deg, #10b981, #34d399);
          box-shadow: 0 6px 20px rgba(16, 185, 129, 0.3);
        }

        .homepage-container .feature-icon.gradient-orange {
          background: linear-gradient(135deg, #f59e0b, #fb923c);
          box-shadow: 0 6px 20px rgba(245, 158, 11, 0.3);
        }

        .homepage-container .feature-title {
          font-size: 1rem;
          font-weight: 700;
          color: white;
        ...
        .homepage-container .feature-description {
          font-size: 0.85rem;
        ...
        .homepage-container .stat-card:hover {
          transform: translateY(-3px);
          box-shadow: 0 15px 30px rgba(0, 0, 0, 0.15);
          border-color: rgba(255, 255, 255, 0.25);
        }

        .homepage-container .stat-icon {
          font-size: 2rem;
          margin-bottom: 0.75rem;
          color: #a855f7;
        }

        .homepage-container .stat-number {
          font-size: 2rem;
          font-weight: 800;
          color: white;
        ...
        /* ===== INPUTS PREMIUM ===== */
        .homepage-container .premium-input {
          width: 100%;
        ...
        .homepage-container .premium-input:focus {
          outline: none;
        ...
        .homepage-container .premium-input::placeholder {
          color: rgba(255, 255, 255, 0.6);
        }

        /* ===== BOTÕES PREMIUM ===== */
        .homepage-container .btn-premium {
          background: linear-gradient(135deg, #8b5cf6, #ec4899);
          border: none;
          border-radius: 12px;
          color: white;
        ...
        .homepage-container .btn-premium::before {
          content: '';
          position: absolute;
          top: 0;
          left: -100%;
        ...
        .homepage-container .btn-premium:hover::before {
          left: 100%;
        }

        .homepage-container .btn-premium:hover:not(:disabled) {
        ...
        .homepage-container .btn-premium:active:not(:disabled) {
          transform: translateY(-1px);
        }

        .homepage-container .btn-premium:disabled {
          opacity: 0.6;
          cursor: not-allowed;
          transform: none;
        }
        ...
        .homepage-container .btn-secondary:hover:not(:disabled) {
        ...
        /* ===== TOAST NOTIFICATION ===== */
        .homepage-container .toast-notification {
          position: fixed;
          top: 1.5rem;
          right: 1.5rem;
          z-index: 9999;
        ...
        .homepage-container .toast-message {
          flex: 1;
          font-weight: 600;
          color: white;
          font-size: 0.9rem;
        ...
        .homepage-container .toast-close {
          background: none;
          border: none;
          color: rgba(255, 255, 255, 0.8);
          cursor: pointer;
        ...
        .homepage-container .toast-close:hover {
          background: rgba(255, 255, 255, 0.1);
          color: white;
        }
        ...
        .homepage-container .form-section {
          display: flex;
          justify-content: center;
          align-items: center;
        }

        .homepage-container .content-sections {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
          padding: 4rem 1rem;
        ...
        @media (max-width: 480px) {
          ...
          .homepage-container .brand-section p {
        ...
        @media (max-width: 360px) {
          ...
          /* Esconder features em telas muito pequenas */
          .homepage-container .brand-section .grid {
            display: none;
          }

          .homepage-container .brand-section .flex.items-center.gap-3 {
            display: none;
          }
        }
      ...
      <div className="min-h-screen gradient-bg relative overflow-hidden homepage-container">
            ...
            <div className="hero-container">
              ...
              <div className="brand-section" style={{ animation: 'fadeInUp 1s ease-out' }}>
                <div className="flex flex-col">
                  ...
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black text-white mb-3 animate-glow leading-tight">
                    <span className="bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent">
                      FitnessTracker
                    </span>
                  </h1>
                  <div className="space-y-2">
                    <p className="text-base sm:text-lg lg:text-xl text-white/90 leading-tight font-light">
                      Transforme sua jornada fitness com tecnologia de ponta
                    </p>
                    <p className="text-xs sm:text-sm lg:text-base text-white/70 font-light">
                      Monitore progresso • Alcance objetivos • Supere limites
                    </p>
                    
                    {/* Features highlights na seção da marca */}
                    <div className="grid grid-cols-2 gap-1 mt-3 pt-3 border-t border-white/20">
                      <div className="flex items-center gap-1">
                        <span className="text-base">📊</span>
                        <span className="text-white/80 font-medium text-xs">Analytics Avançado</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="text-base">🎯</span>
                        <span className="text-white/80 font-medium text-xs">IA Personalizada</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="text-base">🔥</span>
                        <span className="text-white/80 font-medium text-xs">Gamificação</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="text-base">💪</span>
                        <span className="text-white/80 font-medium text-xs">Comunidade Ativa</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mt-3 pt-2">
                      <div className="text-center">
                        <div className="text-lg lg:text-xl font-bold text-white">10k+</div>
              ...
              <div className="form-section" style={{ animation: 'fadeInUp 0.8s ease-out 0.2s both' }}>
                <div className="premium-form" style={{ maxWidth: '400px', width: '100%' }}>
                  <div className="text-center mb-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mx-auto mb-2 animate-pulse">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-2">
                    {isRegistering && (
                      <div style={{ animation: 'fadeInUp 0.5s ease-out' }}>
                        <label className="block text-white font-semibold mb-1 flex items-center gap-1 text-xs">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="absolute right-2 top-1/2 transform -translate-y-1/2 text-white/60 hover:text-white transition-colors text-sm"
                        >
                    ...
                    <div className="relative">
                      ...
                      <div className="relative flex justify-center text-xs bg-transparent">
                        <span className="px-3 bg-gradient-to-r from-purple-600 via-purple-500 to-purple-600 text-white/60 font-medium">ou continue com</span>
                      </div>
                    </div>
                    ...
                    <div className="text-center space-y-1 pt-2">
                      <button
                        ...
                        className="text-white/80 hover:text-white font-medium underline transition-colors duration-300 flex items-center justify-center gap-1 mx-auto text-xs"
                      >
                      ...
                      {!isRegistering && (
                        <button 
                          type="button"
                          className="text-white/60 hover:text-white text-xs underline transition-colors duration-300 flex items-center justify-center gap-1 mx-auto"
                        >
                          <span>🔑</span>
                          Esqueceu sua senha?
                        </button>
