...
const WorkoutDetailPage = () => {
  ...
  const handleToggleComplete = () => {
    try {
      ...
      toast.success(isCompleted ? 'Treino marcado como não concluído' : 'Treino marcado como concluído');
    } catch (error) {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="mb-6">
          <WorkoutProgressBar 
            progress={workoutProgress.overallProgress} 
            lastUpdated={workoutProgress.lastUpdated}
          />
        </div>
