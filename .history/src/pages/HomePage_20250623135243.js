          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="text-center mb-8" style={{ animation: 'fadeInUp 1s ease-out' }}>
              <div className="flex flex-col items-center mb-6">
                ...
                <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white mb-4 animate-glow">
                  <span className="bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent">
                    FitnessTracker
                  </span>
                </h1>
                <div className="max-w-4xl mx-auto">
                  <p className="text-lg sm:text-xl lg:text-2xl text-white/90 leading-relaxed font-light mb-3">
            ...
            <div className="flex justify-center" style={{ animation: 'fadeInUp 0.8s ease-out' }}>
              <div className="premium-form">
                <div className="text-center mb-6">
                  <div className="w-14 h-14 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center mx-auto mb-4 animate-pulse">
