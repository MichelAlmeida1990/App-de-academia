              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {Object.entries(achievementDescriptions)
                  ...
                  .map(([key, description]) => (
                                        <div 
                      key={key} 
                      className="flex items-center p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg opacity-60"
                    >
                      <div className="bg-gray-300 dark:bg-gray-600 p-3 rounded-full mr-4 flex-shrink-0">
          ...
          <div className="card">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <label htmlFor="notification" className="relative inline-flex items-center cursor-pointer">
                  <input 
                    id="notification" 
                    type="checkbox" 
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Receba um resumo dos seus treinos toda semana
                  </p>
                </div>
                <label htmlFor="weekly-summary" className="relative inline-flex items-center cursor-pointer">
                  <input 
                    id="weekly-summary" 
                    type="checkbox" 
                    className="sr-only peer" 
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Oculte suas estatísticas de outros usuários
                  </p>
                </div>
                <label htmlFor="private-profile" className="relative inline-flex items-center cursor-pointer">
                  <input 
                    id="private-profile" 
                    type="checkbox" 
                    className="sr-only peer" 
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <select 
                  id="theme" 
                  className="block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-purple-500 focus:border-purple-500 text-gray-900 dark:text-white"
                  defaultValue="system"
                >
              ...
              {/* Seletor de Unidades */}
              <div>
                <label htmlFor="units" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
                  Unidades de medida
                </label>
                <select 
                  id="units" 
                ...
                onClick={() => {
                  try {
                    import('../utils/pdfExport').then(({ exportProfileDataToPDF }) => {
                      const userData = {}; // Dados do perfil seriam coletados aqui
                      const userStats = {}; // Estatísticas seriam coletadas aqui
                      const settings = {}; // Configurações seriam coletadas aqui
