...
const StatsPage = () => {
  ...
  const { totalWorkouts, totalMinutes, averageMinutes } = getGeneralStats(timeFrame);
  ...
  const getMuscleGroupData = () => {
    // Usar a função do contexto para obter dados de grupos musculares
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className={`p-4 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
              ...
              <p className="text-3xl font-bold">{averageMinutes} min</p>
            </div>
          </div>
