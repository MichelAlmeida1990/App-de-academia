      ...
      <div className="min-h-screen gradient-bg relative overflow-hidden">
        ...
        <div className="hero-section relative z-10">
          <div className="container mx-auto px-4">
            {/* Header Refinado */}
            <div className="text-center mb-12" style={{ animation: 'fadeInUp 1s ease-out' }}>
              <div className="flex flex-col items-center mb-8">
                ...
                <div className="max-w-4xl mx-auto">
                  <p className="text-xl sm:text-2xl lg:text-3xl text-white/90 leading-relaxed font-light mb-4">
            ...
            <div className="flex justify-center mb-16" style={{ animation: 'fadeInUp 0.8s ease-out' }}>
