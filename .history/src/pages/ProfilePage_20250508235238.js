...
const ProfilePage = () => {
  const { getCompletedCount, workouts, resetProgress } = useWorkout();
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
        ...
        <div className="flex-1">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Usuário</h2>
          ...
          <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-4 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-3 bg-white dark:bg-gray-800 rounded-lg shadow">
                <p className="text-sm text-gray-500 dark:text-gray-400">Treinos Concluídos</p>
