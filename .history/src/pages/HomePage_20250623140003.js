      ...
      <div className="min-h-screen gradient-bg relative overflow-hidden">
        ...
        <div className="hero-section relative z-10">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="text-center mb-4" style={{ animation: 'fadeInUp 1s ease-out' }}>
              <div className="flex flex-col items-center mb-4">
                <div className="animate-float mb-2">
                  <span className="text-3xl sm:text-4xl lg:text-5xl">🏋️</span>
                </div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-2 animate-glow">
                  <span className="bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent">
                    FitnessTracker
                  </span>
                </h1>
                <div className="max-w-3xl mx-auto">
                  <p className="text-base sm:text-lg lg:text-xl text-white/90 leading-tight font-light mb-2">
            ...
            <div className="flex justify-center" style={{ animation: 'fadeInUp 0.8s ease-out' }}>
              <div className="premium-form" style={{ maxWidth: '380px' }}>
                <div className="text-center mb-4">
                  <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mx-auto mb-2 animate-pulse">
                    <span className="text-sm">{isRegistering ? '✨' : '🔐'}</span>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  {isRegistering && (
                    <div style={{ animation: 'fadeInUp 0.5s ease-out' }}>
                      <label className="block text-white font-semibold mb-1 flex items-center gap-2 text-xs">
                      ...
                      <input
                        ...
                        style={{ padding: '0.625rem 0.75rem', fontSize: '0.85rem' }}
                      />
                    </div>
                  )}
                  ...
                  <div className="text-center space-y-2 pt-2">
                    <button
                      ...
                      className="text-white/80 hover:text-white font-medium underline transition-colors duration-300 flex items-center justify-center gap-2 mx-auto text-xs"
                    >
