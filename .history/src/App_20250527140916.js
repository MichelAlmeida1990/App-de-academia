// src/App.js - VERSÃO CORRIGIDA COM IMPORT CORRETO
...
import { ToastProvider } from './context/ToastContext'; // ✅ CORRIGIDO: ToastContext
...
// Componente das rotas (dentro do AuthProvider)
const AppRoutes = () => {
  return (
    <Router>
